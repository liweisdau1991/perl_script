...
print OUT "query_name\tquery_length\taccession_number\tlength\tdescription\tE_value\tbit_score\tframe\tquery_start\t";
print OUT "query_end\thit_start\thit_end\tpositives\tidentical\talign_length\n";
